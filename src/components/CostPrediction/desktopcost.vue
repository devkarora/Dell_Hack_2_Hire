            ...
            <v-layout row wrap>
                <v-flex xs12 class="mb-4">
                    <h1 class="display-1 font-weight-light text-xs-center">
                        <v-icon large color="teal">fas fa-desktop</v-icon>
                        Cost Prediction for Desktop
                    </h1>
                </v-flex>
                ...
                <v-flex xs12 sm3 class="px-1">
                    <v-select v-model="mouse" :items="mouses" :rules="[v => !!v || 'Item is required']" label="Mouse" required></v-select>
                </v-flex>
                <v-flex xs12 sm3 class="px-1">
    ...
    <v-flex xs12 v-if="predicted">
        <v-layout row wrap>
            <v-flex sm6 xs12 class="text-xs-center">
                <v-icon color="grey" size="70">fas fa-desktop</v-icon>
                <h1 class="success--text font-weight-light">Great,We have a Desktop !</h1>
...
export default {
    ...
    methods: {
        pred() {
            ...
            var connectionlink = "http://127.0.0.1:5000/getcostofdesktop";
            var config = {
                headers: {
